...
import { hasInjected, isBraveWalletProvider, checkIfBraveBrowser, openWindow } from '../helpers'
...
export const useConnectorMetamask = (args?: ConnectorHookArgs): ConnectorHookResult => {
